...
const query = gql`
  mutation createTreeDataCareObtainingSeedsContent($data: CreateTreeDataCareObtainingSeedsContentInput!){
...
type Response = { createTreeDataCareObtainingSeedsContent: TreeDataCareObtainingSeedsContentProfile };
